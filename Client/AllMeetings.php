	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-12 col-sm-8 col-lg-6">
				...
				<div class="section_heading text-center">
					<h2 class="heading">Meetings Record</h2>
					<p>A list of all meetings requested and/or cancelled are displayed below.</p>
					<div class="line"></div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h6 class="card-title text-center"><a href="" style="text-decoration: none;">Timeline</a></h6>
						<div id="content">
							<ul class="timeline">
								...
								<div class="field">
									...
									<select class="form-select" id="validationCustom02" name="coordinator">
										...
										while ($row2=mysqli_fetch_assoc($sql2))
										{
											...
											$sql3 = mysqli_query($conn,"SELECT * FROM tblpersonalinfo WHERE unique_fk='$coordinatorid'");
...
<script src="javascript/all-meeting.js"></script>
