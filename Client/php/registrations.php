...
$sql = mysqli_query($conn,"SELECT * FROM tblpupil WHERE unique_fk = '$session' AND status='$pending' AND dismiss='$dissmiss' ");
...
$sql0 = mysqli_query($conn,"SELECT * FROM tblpupil WHERE unique_fk = '$session' AND status='$accepted' AND dismiss='$dissmiss'");
...
$sql2 = mysqli_query($conn,"SELECT * FROM tblpupil WHERE unique_fk = '$session' AND status='$declined' AND dismiss='$dissmiss'");
